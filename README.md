...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v2.0.9](https://github.com/asyncapi/modelina/releases/tag/v2.0.9), 2 days ago) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
- [DataDog/dd-trace-php](https://github.com/DataDog/dd-trace-php) ([0.95.0](https://github.com/DataDog/dd-trace-php/releases/tag/0.95.0), 4 days ago) - Datadog PHP Clients
- [asyncapi/generator](https://github.com/asyncapi/generator) ([v1.15.5](https://github.com/asyncapi/generator/releases/tag/v1.15.5), 1 week ago) - Use your AsyncAPI definition to generate literally anything. Markdown documentation, Node.js code, HTML documentation, anything!
