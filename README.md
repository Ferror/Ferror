...
- [DataDog/dd-trace-php](https://github.com/DataDog/dd-trace-php) ([1.0.0beta1](https://github.com/DataDog/dd-trace-php/releases/tag/1.0.0beta1), 1 day ago) - Datadog PHP Clients
- [asyncapi/cli](https://github.com/asyncapi/cli) ([v1.8.3](https://github.com/asyncapi/cli/releases/tag/v1.8.3), 3 days ago) - CLI to work with your AsyncAPI files. You can validate them and in the future use a generator and even bootstrap a new file. Contributions are welcomed!
- [asyncapi/generator](https://github.com/asyncapi/generator) ([v1.17.22](https://github.com/asyncapi/generator/releases/tag/v1.17.22), 3 days ago) - Use your AsyncAPI definition to generate literally anything. Markdown documentation, Node.js code, HTML documentation, anything!
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v3.4.7](https://github.com/asyncapi/modelina/releases/tag/v3.4.7), 3 days ago) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents with high customization
