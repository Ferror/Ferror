...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v4.0.0-next.33](https://github.com/asyncapi/modelina/releases/tag/v4.0.0-next.33), today) - A library for generating typed models based on inputs such as AsyncAPI, OpenAPI, and JSON Schema documents with high customization
