...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v3.2.3](https://github.com/asyncapi/modelina/releases/tag/v3.2.3), today) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
