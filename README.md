...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v3.4.1](https://github.com/asyncapi/modelina/releases/tag/v3.4.1), 1 day ago) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
