...
- [Ferror/phpstan-ddtrace](https://github.com/Ferror/phpstan-ddtrace) - The phpstan STUBS for the datadog/dd-trace-php library, but more convinient (6 days ago)
...
- [asyncapi/cli](https://github.com/asyncapi/cli) ([v2.8.1](https://github.com/asyncapi/cli/releases/tag/v2.8.1), 6 days ago) - CLI to work with your AsyncAPI files. You can validate them and in the future use a generator and even bootstrap a new file. Contributions are welcomed!
