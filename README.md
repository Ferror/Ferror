...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v1.8.5](https://github.com/asyncapi/modelina/releases/tag/v1.8.5), 1 day ago) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
