...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v1.9.0](https://github.com/asyncapi/modelina/releases/tag/v1.9.0), 2 days ago) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
