...
- [asyncapi/cli](https://github.com/asyncapi/cli) ([v1.5.8](https://github.com/asyncapi/cli/releases/tag/v1.5.8), today) - CLI to work with your AsyncAPI files. You can validate them and in the future use a generator and even bootstrap a new file. Contributions are welcomed!
