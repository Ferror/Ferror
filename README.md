...
- [asyncapi/cli](https://github.com/asyncapi/cli) ([v1.14.0](https://github.com/asyncapi/cli/releases/tag/v1.14.0), 1 day ago) - CLI to work with your AsyncAPI files. You can validate them and in the future use a generator and even bootstrap a new file. Contributions are welcomed!
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v3.5.0](https://github.com/asyncapi/modelina/releases/tag/v3.5.0), 3 days ago) - A library for generating typed models based on inputs such as AsyncAPI, OpenAPI, and JSON Schema documents with high customization
