...
- [Ferror/asyncapi-doc-bundle](https://github.com/Ferror/asyncapi-doc-bundle) ([0.1.0-alpha.6](https://github.com/Ferror/asyncapi-doc-bundle/releases/tag/0.1.0-alpha.6), today) - Document Async API with PHP Attributes
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v2.1.2](https://github.com/asyncapi/modelina/releases/tag/v2.1.2), today) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
- [asyncapi/generator](https://github.com/asyncapi/generator) ([v1.17.2](https://github.com/asyncapi/generator/releases/tag/v1.17.2), today) - Use your AsyncAPI definition to generate literally anything. Markdown documentation, Node.js code, HTML documentation, anything!
- [asyncapi/cli](https://github.com/asyncapi/cli) ([v1.4.4](https://github.com/asyncapi/cli/releases/tag/v1.4.4), today) - CLI to work with your AsyncAPI files. You can validate them and in the future use a generator and even bootstrap a new file. Contributions are welcomed!
