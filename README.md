...
- [asyncapi/generator](https://github.com/asyncapi/generator) ([v1.15.7](https://github.com/asyncapi/generator/releases/tag/v1.15.7), today) - Use your AsyncAPI definition to generate literally anything. Markdown documentation, Node.js code, HTML documentation, anything!
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v2.0.9](https://github.com/asyncapi/modelina/releases/tag/v2.0.9), 4 days ago) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
