...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v3.5.1](https://github.com/asyncapi/modelina/releases/tag/v3.5.1), today) - A library for generating typed models based on inputs such as AsyncAPI, OpenAPI, and JSON Schema documents with high customization
