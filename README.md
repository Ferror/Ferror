...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v1.8.2](https://github.com/asyncapi/modelina/releases/tag/v1.8.2), today) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
