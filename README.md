...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v3.1.0](https://github.com/asyncapi/modelina/releases/tag/v3.1.0), today) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
