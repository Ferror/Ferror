...
- [DataDog/dd-trace-php](https://github.com/DataDog/dd-trace-php) - Datadog Tracing PHP Client (5 days ago)
...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v2.0.0-next.18](https://github.com/asyncapi/modelina/releases/tag/v2.0.0-next.18), today) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
