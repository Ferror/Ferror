...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v2.0.9](https://github.com/asyncapi/modelina/releases/tag/v2.0.9), 3 days ago) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
- [DataDog/dd-trace-php](https://github.com/DataDog/dd-trace-php) ([0.95.0](https://github.com/DataDog/dd-trace-php/releases/tag/0.95.0), 5 days ago) - Datadog PHP Clients
