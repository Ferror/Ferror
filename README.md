...
- [Ferror/asyncapi-event-catalog-v2](https://github.com/Ferror/asyncapi-event-catalog-v2) - Event Catalog V2 Setup with Github Actions (5 days ago)
...
- [asyncapi/cli](https://github.com/asyncapi/cli) ([v2.3.13](https://github.com/asyncapi/cli/releases/tag/v2.3.13), 1 day ago) - CLI to work with your AsyncAPI files. You can validate them and in the future use a generator and even bootstrap a new file. Contributions are welcomed!
