...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v4.0.0-next.29](https://github.com/asyncapi/modelina/releases/tag/v4.0.0-next.29), today) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents with high customization
