...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v2.0.0-next.11](https://github.com/asyncapi/modelina/releases/tag/v2.0.0-next.11), today) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
