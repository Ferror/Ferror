...
- [asyncapi/cli](https://github.com/asyncapi/cli) ([v1.5.2](https://github.com/asyncapi/cli/releases/tag/v1.5.2), today) - CLI to work with your AsyncAPI files. You can validate them and in the future use a generator and even bootstrap a new file. Contributions are welcomed!
- [asyncapi/generator](https://github.com/asyncapi/generator) ([v1.17.5](https://github.com/asyncapi/generator/releases/tag/v1.17.5), today) - Use your AsyncAPI definition to generate literally anything. Markdown documentation, Node.js code, HTML documentation, anything!
