...
- [asyncapi/modelina](https://github.com/asyncapi/modelina) ([v2.0.0-next.24](https://github.com/asyncapi/modelina/releases/tag/v2.0.0-next.24), 1 day ago) - A library for generating data models based on inputs such as AsyncAPI, OpenAPI, or JSON Schema documents.
- [DataDog/dd-trace-php](https://github.com/DataDog/dd-trace-php) ([0.92.2](https://github.com/DataDog/dd-trace-php/releases/tag/0.92.2), 4 days ago) - Datadog Tracing PHP Client
